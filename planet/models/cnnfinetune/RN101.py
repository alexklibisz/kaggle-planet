...
def resnet101_model(img_rows, img_cols, color_type=1, num_classes=None, preprocess_layer=None, pretrained=False):
    """
    ...
    if pretrained:
        model.load_weights('data/weights/resnet101_weights_tf.h5', by_name=True)
